            ...
            <div className="mx-auto flex justify-center items-center h-5 sm:h-10 px-2">
                <div className="flex w-full md:mx-auto  rounded-full relative">
                    <input
                        ...
                        className="lg:w-80 border text-white border-gray-400 
              h-5 sm:h-full
              rounded-2xl focus:border-red-400 focus:outline-none focus:font-semibold focus:ps-3 p-1 placeholder:ps-3 placeholder:font-semibold placeholder:text-gray-500 "
                        id="searchInput"
                        onChange={(e) => {
                            handleSearchInput(e);
                    ...
                    <button className="px-1 mx-2 sm:px-4 sm:ms-3  items-center justify-center bg-gray-700 hover:bg-gray-800 text-white cursor-pointer rounded-2xl relative  flex">
                        ...
                        {filterState && (
                            <>
                                ...
                                >
                                    <option value="video,channel,playlist">
                                        All
                                    </option>
